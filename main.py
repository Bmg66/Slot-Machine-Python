    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if amount > 0:
                ...
                print("Please enter a valid (greater than 0)")
        else:
    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if 1 <= lines <= MAX_LINES:
                ...
                print("Please enter a valid number of lines (greater than 0)")
        else:
            print("Please enter a valid number")
    return lines
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have enough money to play this game. Your balance is ${balance}")
        else:
            break
